...
class DRIL:
    def __init__(self, device=None, envs=None, ensemble_policy=None, env_name=None,
        ...
        training_data_split=None, dril_alpha=None):
    ...
    def bc_update(self):
        for dril_epoch in range(self.num_dril_bc_train_epoch):
            dril_train_loss = self.bc.update(update=True, data_loader_type='train', dril_alpha=self.dril_alpha)
