...
def main():
    ...
    print(args.dril_alpha)
    if args.behavior_cloning or (args.dril and args.warm_start):
    ...
    if args.dril:
        ...
        dril = DRIL(device=device,envs=envs,ensemble_policy=ensemble_policy,
           ...
           training_data_split=args.training_data_split, dril_alpha=args.dril_alpha)
    else:
        dril = None
...
def save_results(args, main_results, algo, dril, gail):
    ...
    if dril:
        ...
        exp_name += f'warm={args.warm_start}_'
        exp_name += f'alpha={args.dril_alpha}_'
        # exp_name += f'sample={args.ensemble_shuffle_type}_'
